...
// the substrates
Transfinite Line{19,21,23,25,31,33,35,37} = 7;
Transfinite Line{27,28,29,30,39,40,41,42} = 12;
...
Physical Surface(11) = {11}; // Make plane surface 1 a physical surface
...
Physical Surface(17) = {17}; // Make plane surface 1 a physical surface
